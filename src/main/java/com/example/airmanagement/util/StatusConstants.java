...
public class StatusConstants {
    ...
    public static final String SUCCESSFULLY_ADDED_AIRCOMPANY = "New AirCompany was added successfully";
    public static final String SUCCESSFULLY_DELETED_AIRCOMPANY = "AirCompany was deleted successfully";
    public static final String UNSUCCESSFUL_DELETED_AIRCOMPANY = "There is no AirCompany with this id: ";
    public static final String SUCCESSFULLY_UPDATED_AIRCOMPANY = "This AirCompany was updated successfully";
